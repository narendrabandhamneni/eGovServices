 ...
 * will be used on the server. Author : Pavan Kumar Kamma
 */
...
public class UserInfo {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.tenantId, userInfo.tenantId)
				...
				&& Objects.equals(this.additionalroles,
						userInfo.additionalroles);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tenantId, id, username, mobile, email, primaryrole,
				additionalroles);
	}
	...
	public String toString() {
		...
		sb.append("    primaryrole: ").append(toIndentedString(primaryrole))
				.append("\n");
		sb.append("    additionalroles: ")
				.append(toIndentedString(additionalroles)).append("\n");
		sb.append("}");
		return sb.toString();
	}
