...
public class CalculatorRepostory {
    ...
    public Long saveGuidanceValue(String tenantId, GuidanceValue guidanceValue) {
        ...
        final PreparedStatementCreator psc = new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(final Connection con) throws SQLException {
                ...
                ps.setTimestamp(10, TimeStampUtil
                        .getTimeStamp(guidanceValue.getToDate()));
    ...
    public List<GuidanceValue> searchGuidanceValue(String tenantId,
            String boundary, String structure, String usage, String subUsage, String occupancy, String validDate, String code) {

        String guidanceValueSearchSql = GuidanceValueBuilder
                .getGuidanceValueSearchQuery(tenantId, boundary, structure, usage, subUsage, occupancy, validDate, code);
