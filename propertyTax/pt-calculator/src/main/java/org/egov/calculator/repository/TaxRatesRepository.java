...
public class TaxRatesRepository {
	...
	public List<TaxRates> searchTaxRates(String tenantId, String taxHead, String validDate, Double validARVAmount, String parentTaxHead) {

		String taxRatesSelect = TaxRatesBuilder.getTaxRatesSearchQuery(tenantId, taxHead, validDate, validARVAmount, parentTaxHead);
